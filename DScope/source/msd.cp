#line 1 "Z:/Robs Folder/DScope/source/msd.c"
...
#line 8 "Z:/Robs Folder/DScope/source/msd.c"
unsigned char SectorBuff[512];
#line 13 "Z:/Robs Folder/DScope/source/msd.c"
void Delay_us(void)
{ u32 dlyCount = 0x100;
 while(--dlyCount);
}
#line 20 "Z:/Robs Folder/DScope/source/msd.c"
u8 MSD_Init(void)
{ u32 i=0;
 SPI_Config();
  (*((vu32 *)( ( ( ((u32)0x40000000)  + 0x10000)  + 0x0C00) +0x10)))  = ((u16)0x1000) ;
 for(i=0; i <10; i++) MSD_WriteByte( 0xFF );
 return (MSD_GoIdleState());
}
#line 30 "Z:/Robs Folder/DScope/source/msd.c"
u8 MSD_WriteBlock(u8* pBuffer, u32 WriteAddr, u16 NumByteToWrite)
{ u32 i=0;
 u8 rvalue =  0xFF ;
  (*((vu32 *)( ( ( ((u32)0x40000000)  + 0x10000)  + 0x0C00) +0x14)))  = ((u16)0x1000) ;
 Delay_us(1);
 ...
 if(MSD_GetDataResponse()== 0x05 ) rvalue= 0x00 ;
 }
  (*((vu32 *)( ( ( ((u32)0x40000000)  + 0x10000)  + 0x0C00) +0x10)))  = ((u16)0x1000) ; MSD_WriteByte( 0xFF );
 return rvalue;
}
#line 51 "Z:/Robs Folder/DScope/source/msd.c"
u8 MSD_ReadBlock(u8* pBuffer, u32 ReadAddr, u16 NumByteToRead)
{ u32 i = 0; u8 rvalue =  0xFF ;
  (*((vu32 *)( ( ( ((u32)0x40000000)  + 0x10000)  + 0x0C00) +0x14)))  = ((u16)0x1000) ; Delay_us(1);
...
#line 70 "Z:/Robs Folder/DScope/source/msd.c"
u8 MSD_WriteBuffer(u8* pBuffer, u32 WriteAddr, u32 NumByteToWrite)
{ u32 i=0, NbrOfBlock=0, Offset=0; u8 rvalue= 0xFF ;
...
#line 97 "Z:/Robs Folder/DScope/source/msd.c"
u8 MSD_ReadBuffer(u8* pBuffer, u32 ReadAddr, u32 NumByteToRead)
{ u32 i=0, NbrOfBlock=0, Offset=0; u8 rvalue= 0xFF ;
...
#line 133 "Z:/Robs Folder/DScope/source/msd.c"
u8 MSD_GetCSDRegister(sMSD_CSD* MSD_csd)
{
 u32 i = 0;
 u8 rvalue =  0xFF ;
...
#line 243 "Z:/Robs Folder/DScope/source/msd.c"
u8 MSD_GetCIDRegister(sMSD_CID* MSD_cid)
{
 u32 i = 0;
 u8 rvalue =  0xFF ;
...
#line 328 "Z:/Robs Folder/DScope/source/msd.c"
void MSD_SendCmd(u8 Cmd, u32 Arg, u8 Crc)
{ u32 i=0; u8 Frame[6];
 Frame[0] = (Cmd | 0x40);
 Frame[1] = (u8)(Arg >> 24);
...
#line 349 "Z:/Robs Folder/DScope/source/msd.c"
u8 MSD_GetDataResponse(void)
...
#line 385 "Z:/Robs Folder/DScope/source/msd.c"
u8 MSD_GetResponse(u8 Response)
{ u32 Count=0xFFF;
 while ((MSD_ReadByte()!=Response)&& Count) Count--;
 if (Count==0) return  0xFF ;
 else return  0x00 ;
}
#line 398 "Z:/Robs Folder/DScope/source/msd.c"
u16 MSD_GetStatus(void)
{
 u16 Status = 0;
...
#line 428 "Z:/Robs Folder/DScope/source/msd.c"
u8 MSD_GoIdleState(void)
{
